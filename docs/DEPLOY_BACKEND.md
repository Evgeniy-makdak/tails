...
**Рекомендация без карты: Render Free** (ниже пошагово). Минус free: после простоя сервис спит; первое сообщение / открытие чата может подождать ~минуту, пока поднимется.
